...
public class Arbre<T extends Comparable<? super T>> implements Iterable<T>{
    ...
    public Iterator<T> iterator() {
        switch(this.parcours){
            case PARCOURS.PREFIX : return new IterateurArbre<>(this);
            case PARCOURS.INFIX : return new IterateurArbreInfixe<>(this);
            case PARCOURS.POSTFIX : return new IterateurArbrePost<>(this);
            case PARCOURS.BFS : return new IterateurArbreBFS<>(this);
    ...
    public Iterator<T> iteratorInfixe() {
        return new IterateurArbreInfixe<T>(this);
